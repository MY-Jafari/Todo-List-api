...
def test_task_retrieve_update_destroy_view(authenticated_user):
    ...
    task_obj = Task.objects.create(
        user=user, list=list_obj, task_title="Task to Manage", status="todo"
    )
